...
<div id="blockinstagram" class="full-width">
  ...
  <h1 class="h1 text-uppercase products-section-title">News and Media</h1>
  		<div class="col-sm-6 col-md-4 grid" style="position:relative">
...
Follow us on Instagram
    		...
    		<div class="pink-balloon">
    		  <a target="_blank" href="https://www.instagram.com/gellifique_gel_colour/">Follow us on Instagram!</a>
    		</div>
  		</div>
